 ...
 */
class Tortuga_Magazine_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'tortuga-magazine-posts-grid', // ID.
			esc_html__( 'Magazine (Grid)', 'tortuga' ), // Name.
			array(
				'classname' => 'tortuga-magazine-grid-widget',
				'description' => esc_html__( 'Displays your posts from a selected category in a grid layout.', 'tortuga' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Grid)', 'tortuga' ),
			'category' => 0,
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'layout' ); ?>"><?php esc_html_e( 'Grid Layout:', 'tortuga' ); ?></label><br/>
			<select id="<?php echo $this->get_field_id( 'layout' ); ?>" name="<?php echo $this->get_field_name( 'layout' ); ?>">
				<option <?php selected( $settings['layout'], 'two-columns' ); ?> value="two-columns" ><?php esc_html_e( 'Two Columns Grid', 'tortuga' ); ?></option>
				<option <?php selected( $settings['layout'], 'three-columns' ); ?> value="three-columns" ><?php esc_html_e( 'Three Columns Grid', 'tortuga' ); ?></option>
			</select>
		</p>
 ...
 * Register Widget
 */
function tortuga_register_magazine_posts_grid_widget() {

	register_widget( 'Tortuga_Magazine_Posts_Grid_Widget' );

}
add_action( 'widgets_init', 'tortuga_register_magazine_posts_grid_widget' );
