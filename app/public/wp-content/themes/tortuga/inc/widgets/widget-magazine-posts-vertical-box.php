 ...
 */
class Tortuga_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'tortuga-magazine-vertical-box', // ID.
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = tortuga_get_magazine_post_ids( $this->id, $settings['category'], 5 );
 ...
 * Register Widget
 */
function tortuga_register_magazine_posts_vertical_box_widget() {

	register_widget( 'Tortuga_Magazine_Vertical_Box_Widget' );

}
add_action( 'widgets_init', 'tortuga_register_magazine_posts_vertical_box_widget' );
