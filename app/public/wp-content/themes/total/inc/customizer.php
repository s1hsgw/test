...
function total_customize_register( $wp_customize ) {
	...
	<li>' . __( "16 Front page sections with lots of variations" , "total" ) . '</li>
	...
	<li>' . __( "Fully RTL(Right to left) languages compatible" , "total" ) . '</li>
	</ul>
