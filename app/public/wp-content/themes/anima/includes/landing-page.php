...
function anima_lpblocks() {
	...
	$blocksreadmore = cryout_get_option( 'anima_lpblocksreadmore' );
	$count = 1;
			...
			<div class="lp-block block<?php echo absint( $id ); ?>">
				...
				<?php if ( $click ) { ?></a> <?php } ?>
					<div class="lp-block-content">
						...
						<?php if ( ! empty ( $readmore ) ) { ?><a class="lp-block-readmore" href="<?php echo esc_url( $link ); ?>" <?php echo esc_attr( $target ); ?>> <?php echo do_shortcode( wp_kses_post( $readmore ) ); ?> </a><?php } ?>
